...
# 需要用conda安装torch和torchvision，否则pip安装的torch version会是1.12.1+cu102, conda装的会是1.12.1
# 降低pip的版本: python -m pip install pip==21.2.4，否则无法装自带的fairseq
...
class Trainer(object):
    ...
    def valid_step(self, sample, raise_oom=False):
        ...
        with torch.no_grad():
            ...
            try:
                _loss, sample_size, logging_output, f1_dict, class_ago_dict = self.task.valid_step(
        ...
        return logging_output, f1_dict, class_ago_dict
